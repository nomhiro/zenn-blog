...
> OneManCompany（略称 OMC）は、「一人会社のための AI OS」をうたう OSS です。ブラウザから、丸ごと AI で動く会社を作って運営できる、というのを目指しています。

考え方はとてもシンプルです。**あなたが CEO（唯一の人間）** で、HR・COO・エンジニア・デザイナーといった他の全員は、自分で考えて動き、実際に成果物まで出してくれる **AI 従業員** です。「サボらない、病欠しない、昇給も要求しない。たまに激励が必要なくらい」というのが売り文句です。

ただのチャットボットでも、エージェントの寄せ集めでもなく、**会社の運営まるごとを OS にしてしまおう**としているのが、いちばんの特徴ですね。
...
OMC が出てきた背景には、2026 年に盛り上がっている **「一人会社（one-person company）／ソロ・ユニコーン」** という流れがあります。少し調べてみたので、ざっくり整理してみます。

- これまで、ビジネスのボトルネックは「**人手**」だった。成果を増やすには人を雇うしかなかった。
- AI エージェントは人の作業を速くするだけでなく、成果を生み出すコストそのものを下げる。生産が安くなれば、人数に頼ったビジネスのかたちは崩れていく。
- 規模を広げる単位が、「従業員」から「エージェント」へ移っていく。
- そこで生まれるのが **一人会社** という新しいスタイル。運営者ひとりが AI の仕組みの真ん中に座り、10 人チームぶんの成果を出しつつ、人間は戦略やセンス、顧客への価値づくりに集中する。

OMC は、こうした流れを個別ツールの寄せ集めではなく、ひとつの OS としてまとめてしまおう、という試みなんだと思います。

:::message
ただ、AI が出した成果をちゃんとビジネスにつなげられないと、その分のコストがまるごと無駄になってしまいます。
特に最近は AI ツールが従量課金に寄ってきているので、**コスト管理**も無視できなくなってきます。
:::
...
`langchain_openai.ChatOpenAI` は OpenAI SDK と同じ Bearer 認証なので、**OMC 側のコードはいじらずに済む**はずです。全体の繋がりを図にすると、こんな流れですね。
